...
nbits = 100;
nchannels = 96;
cable = 1; % 1 por cable, 0 por aire
if cable == 1
...
disp(['Tiempo de transmisión total = ', num2str(tiempo_audio),'segundos'])
disp(['Tiempo de transmisión datos  = ', num2str(1440/(2*fswitch)),'segundos'])
